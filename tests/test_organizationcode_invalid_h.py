...
"""
Test Run: Invalid Value 'H' in OrganizationCode Column
...
class TestOrganizationCodeInvalidH:
    
    @allure.description("""
    Test that pipeline rejects invalid value 'H' in OrganizationCode column.
    
    Steps:
    1. Generate invalid parquet file with 'H' value in OrganizationCode
    ...
    def test_organizationcode_invalid_h(self):
        """
        Test that pipeline rejects invalid value 'H' in OrganizationCode column.
        ...
        # Run the pipeline with invalid 'H' value injected into OrganizationCode column
        pipe_command = [
        ...
        with allure.step("Inject invalid value 'H' into OrganizationCode column"):
            print("=" * 60)
            print("TEST: Invalid Value 'H' in OrganizationCode Column")
            print("=" * 60)
            print(f"Injecting: H into OrganizationCode column")
