...
"""
Test Run: Numeric Value in ContactLastName Column
Injects numeric value '123456789' into the ContactLastName column to test ETL validation.
"""

@allure.feature('ETL Validation')
@allure.story('Invalid Data Handling')
@allure.title('Test ContactLastName Column with Numeric Value (123456789)')
class TestContactLastNameInvalidNumeric:
    
    @allure.description("""
    Test that pipeline rejects numeric value '123456789' in ContactLastName column.
    
    Steps:
    1. Generate invalid parquet file with numeric value '123456789' in ContactLastName
    ...
    def test_contactlastname_invalid_numeric(self):
        ...
        # Run the pipeline with numeric value '123456789' injected into ContactLastName column
        pipe_command = [
            sys.executable, pipeline_path,
            "--invalid-values", "ContactLastName:123456789",
            "--dev2",
            "--rows", "25"
        ]
        
        with allure.step("Inject numeric value '123456789' into ContactLastName column"):
            print("=" * 60)
            print("TEST: Numeric Value '123456789' in ContactLastName Column")
            print("=" * 60)
            print(f"Injecting: 123456789 into ContactLastName column")
