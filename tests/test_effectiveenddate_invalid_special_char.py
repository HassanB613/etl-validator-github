...
"""
Test Run: Special Characters in EffectiveEndDate Column
Injects special characters '@#$%!!' into the EffectiveEndDate column to test ETL validation.
"""

@allure.feature('ETL Validation')
@allure.story('Invalid Data Handling')
@allure.title('Test EffectiveEndDate Column with Special Characters (@#$%!!)')
class TestEffectiveEndDateInvalidSpecialChar:
    
    @allure.description("""
    Test that pipeline rejects special characters '@#$%!!' in EffectiveEndDate column.
    
    Steps:
    1. Generate invalid parquet file with special characters '@#$%!!' in EffectiveEndDate
    ...
    def test_effectiveenddate_invalid_special_char(self):
        """
        Test that pipeline rejects special characters '@#$%!!' in EffectiveEndDate column.
        ...
        # Run the pipeline with special characters '@#$%!!' injected into EffectiveEndDate column
        pipe_command = [
        ...
        with allure.step("Inject special characters '@#$%!!' into EffectiveEndDate column"):
            print("=" * 60)
            print("TEST: Special Characters '@#$%!!' in EffectiveEndDate Column")
            print("=" * 60)
            print(f"Injecting: @#$%!! into EffectiveEndDate column")
