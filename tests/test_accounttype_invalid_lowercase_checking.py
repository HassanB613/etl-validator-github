...
Injects lowercase value 'checking' into the AccountType column to test ETL validation.
"""

@allure.feature('ETL Validation')
@allure.story('Invalid Data Handling')
@allure.title('Test AccountType Column with Lowercase Value (checking)')
class TestAccountTypeInvalidLowercaseChecking:
    
    @allure.description("""
    Test that pipeline rejects lowercase value 'checking' in AccountType column.
    
    Steps:
    1. Generate invalid parquet file with lowercase value 'checking' in AccountType
    ...
    def test_accounttype_invalid_lowercase_checking(self):
        """
        Test that pipeline rejects lowercase value 'checking' in AccountType column.
        ...
        # Run the pipeline with lowercase value 'checking' injected into AccountType column
        pipe_command = [
        ...
        with allure.step("Inject lowercase value 'checking' into AccountType column"):
            print("=" * 60)
            print("TEST: Lowercase Value 'checking' in AccountType Column")
            print("=" * 60)
            print(f"Injecting: checking into AccountType column")
