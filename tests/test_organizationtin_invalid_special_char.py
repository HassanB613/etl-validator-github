...
"""
Test Run: Special Characters in OrganizationTIN Column
Injects special characters (!@#$) into the OrganizationTIN column to test ETL validation.
"""

@allure.feature('ETL Validation')
@allure.story('Invalid Data Handling')
@allure.title('Test OrganizationTIN Column with Invalid Special Characters')
class TestOrganizationTINSpecialChar:
    
    @allure.description("""
    Test that pipeline rejects invalid special characters in OrganizationTIN column.
    
    Steps:
    1. Generate invalid parquet file with special characters (!@#$) in OrganizationTIN
    ...
    def test_organizationtin_invalid_special_char(self):
        """
        Test that pipeline rejects invalid special characters in OrganizationTIN column.
        ...
        # Run the pipeline with special characters (!@#$) injected into OrganizationTIN column
        pipe_command = [
        ...
        with allure.step("Inject special characters (!@#$) into OrganizationTIN column"):
            print("=" * 60)
            print("TEST: Special Characters '!@#$' in OrganizationTIN Column")
            print("=" * 60)
            print(f"Injecting: !@#$ into OrganizationTIN column")
