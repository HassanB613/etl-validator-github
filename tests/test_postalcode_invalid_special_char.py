...
"""
Test Run: Special Characters in PostalCode Column
Injects special characters '@#$%!!' into the PostalCode column to test ETL validation.
"""

@allure.feature('ETL Validation')
@allure.story('Invalid Data Handling')
@allure.title('Test PostalCode Column with Special Characters (@#$%!!)')
class TestPostalCodeInvalidSpecialChar:
    
    @allure.description("""
    Test that pipeline rejects special characters '@#$%!!' in PostalCode column.
    
    Steps:
    1. Generate invalid parquet file with special characters '@#$%!!' in PostalCode
    ...
    def test_postalcode_invalid_special_char(self):
        """
        Test that pipeline rejects special characters '@#$%!!' in PostalCode column.
        ...
        # Run the pipeline with special characters '@#$%!!' injected into PostalCode column
        pipe_command = [
        ...
        with allure.step("Inject special characters '@#$%!!' into PostalCode column"):
            print("=" * 60)
            print("TEST: Special Characters '@#$%!!' in PostalCode Column")
            print("=" * 60)
            print(f"Injecting: @#$%!! into PostalCode column")
