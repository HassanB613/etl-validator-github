...
"""
Test Run: Special Characters in ProfitNonprofit Column
Injects special characters (@!#$&&) into the ProfitNonprofit column to test ETL validation.
"""

@allure.feature('ETL Validation')
@allure.story('Invalid Data Handling')
@allure.title('Test ProfitNonprofit Column with Invalid Special Characters')
class TestProfitNonprofitSpecialChar:
    ...
    def test_profitnonprofit_invalid_special_char(self):
        ...
        # Run the pipeline with special characters (@!#$&&) injected into ProfitNonprofit column
        pipe_command = [
        ...
        with allure.step("Inject special characters (@!#$&&) into ProfitNonprofit column"):
            print("=" * 60)
            print("TEST: Special Characters '@!#$&&' in ProfitNonprofit Column")
            print("=" * 60)
            print(f"Injecting: @!#$&& into ProfitNonprofit column")
